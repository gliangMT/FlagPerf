...
int test() {
    ...
    std::cout << "Average " << "INT8" << " Single Op Duration: " << duration.count() / NUM_ITERATIONS << " us" << std::endl;

    // std::cout << "[MUSA EVENTS]Average " << "INT8" << " Single Op Duration: " << elapsed_time * 1000 / NUM_ITERATIONS << " us" << std::endl;
